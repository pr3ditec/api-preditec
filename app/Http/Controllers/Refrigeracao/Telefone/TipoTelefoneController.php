...
namespace App\Http\Controllers\Refrigeracao\Telefone;

use App\Http\Controllers\Controller;
use App\Http\Requests\Refrigeracao\TipoTelefone\AlterarTipoTelefoneRequest;
use App\Http\Requests\Refrigeracao\TipoTelefone\CriarTipoTelefoneRequest;
use App\Models\Refrigeracao\TipoTelefone;
use Exception;
...
{
    /** CONTROLE GLOBAL */
    public $model = TipoTelefone::class;
    /** CONTROLE GLOBAL */
    ...
    public function store(CriarTipoTelefoneRequest $request)
    {
    ...
    public function update(AlterarTipoTelefoneRequest $request, int $id)
    {
        try {
