...
use App\Http\Requests\Refrigeracao\ServicoEndereco\AlterarServicoEnderecoRequest;
use App\Http\Requests\Refrigeracao\ServicoEndereco\CriarServicoEnderecoRequest;
use App\Models\Refrigeracao\ServicoEndereco;
use Exception;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Http\Request;

class ServicoEnderecoController extends Controller
{
/** CONTROLE GLOBAL */
public $model = ServicoEndereco::class;
/** CONTROLE GLOBAL */
...
public function store(CriarServicoEnderecoRequest $request)
{
...
public function update(AlterarServicoEnderecoRequest $request, int $id)
{
    try {
