...
use App\Http\Requests\Refrigeracao\Documento\AlterarDocumentoRequest;
use App\Http\Requests\Refrigeracao\Documento\CriarDocumentoRequest;
use App\Models\Refrigeracao\Documento;
use Exception;
...
class DocumentoController extends Controller
{
    ...
    public function store(CriarDocumentoRequest $request)
    {
    ...
    public function update(AlterarDocumentoRequest $request, int $id)
    {
        try {
