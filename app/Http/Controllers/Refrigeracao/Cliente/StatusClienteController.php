...
use App\Http\Requests\Refrigeracao\StatusCliente\AlterarStatusClienteRequest;
use App\Http\Requests\Refrigeracao\StatusCliente\CriarStatusClienteRequest;
...
{
    /** CONTROLE GLOBAL */
    public $model = StatusCliente::class;
    /** CONTROLE GLOBAL */
    ...
    public function store(CriarStatusClienteRequest $request)
    {
    ...
    public function update(AlterarStatusClienteRequest $request, int $id)
    {
        try {
